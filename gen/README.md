...
Rest api Korchemnyi
- API version: 1.0.0
  - Build date: 2021-12-18T03:24:05.596072+03:00[Europe/Moscow]
...
------------ | ------------- | ------------- | -------------
*ItemApi* | [**additem**](docs/ItemApi.md#additem) | **POST** /products | Add new product to products
*ItemApi* | [**updateItem**](docs/ItemApi.md#updateItem) | **PUT** /products | Update an existing pet
